...
const achievements = [
  ...
  },
  {
    ...
    description: "Awarded for promoting sustainable and eco-friendly solutions.",
    shape: "square",
  },
  {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-12">
        {achievements.map((item, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-end text-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-full group-hover:translate-y-0">
